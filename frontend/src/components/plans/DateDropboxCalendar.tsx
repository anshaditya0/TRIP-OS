        ...
        {isOpen && (
          ...
          >
            ...
            <div className="pt-2.5 border-t border-slate-100 flex items-center justify-between">
              <div className="flex items-center gap-1.5 text-[10px] font-mono text-slate-500 font-bold uppercase truncate max-w-[180px]">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl bg-neutral-900 hover:bg-black text-white text-[10px] font-mono font-black uppercase tracking-wider flex items-center gap-1.5 shadow-xs cursor-pointer transition-all active:scale-95"
              >
